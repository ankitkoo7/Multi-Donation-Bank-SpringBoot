...
<link rel="stylesheet" type="text/css"
	href="assets/css/ngologinstyle.css">
<meta charset="utf-8">
								...
								<div class="main-menu f-right d-none d-lg-block">
									<nav>
										<ul id="navigation">
											...
											<li><a href="cases">Donation Received</a></li>
			...
			<div class="card">
				...
				<div class="card-footer">
					<div class="d-flex justify-content-center links">
						Don't have an account?<a href="contact">Request Account</a>
					</div>
				</div>
			</div>
		</div>
